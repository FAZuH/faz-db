...
from vindicator import PlayerHistoryRepo
...
class PlayerHistoryTable(PlayerHistoryRepo):
    ...
    async def insert(self, connection: None | Connection, entity: Iterable[PlayerHistory]) -> bool:
        sql = f"""
    ...
    async def exists(self, id_: PlayerHistoryId) -> bool: ...

    async def count(self) -> float: ...

    async def find_one(self, id_: PlayerHistoryId) -> None | PlayerHistory: ...

    async def find_all(self) -> None | list[PlayerHistory]: ...

    async def update(self, entity: PlayerHistory) -> bool: ...

    async def delete(self, id_: PlayerHistoryId) -> bool: ...
