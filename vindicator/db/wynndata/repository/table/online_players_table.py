...
class OnlinePlayersTable(OnlinePlayersBase):
    ...
    async def exists(self, id: OnlinePlayersId) -> bool: ...

    async def count(self) -> float: ...

    async def find_one(self, id: OnlinePlayersId) -> None | OnlinePlayers: ...

    async def find_all(self) -> None | list[OnlinePlayers]: ...

    async def update(self, entity: OnlinePlayers) -> bool: ...

    async def delete(self, id: OnlinePlayersId) -> bool: ...
