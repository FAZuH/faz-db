...
class CharacterHistoryTable(CharacterHistoryBase):
    ...
    async def exists(self, id: CharacterHistoryId) -> bool: ...

    async def count(self) -> float: ...

    async def find_one(self, id: CharacterHistoryId) -> None | CharacterHistory: ...

    async def find_all(self) -> None | list[CharacterHistory]: ...

    async def update(self, entity: CharacterHistory) -> bool: ...

    async def delete(self, id: CharacterHistoryId) -> bool: ...
